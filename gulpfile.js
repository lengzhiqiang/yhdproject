...
const fontsHandler = ()=>{
    return gulp.src('./src/font/**')  //images文件夹下的所有文档
    .pipe(gulp.dest('./dist/font'))   //放到指定的目录就可以了
}



const phpHandler = ()=>{
    return gulp.src('./src/server/**')  //images文件夹下的所有文档
    .pipe(gulp.dest('./dist/server'))   //放到指定的目录就可以了
}
...
module.exports.default = gulp.series(
    delHandler,
    gulp.parallel(cssHandler,jsHanlder,htmlHandler,imgHandler,libHandler,fontsHandler,phpHandler),
    // serverHandler,
    watchHandler
)
